...
**********************************************************************
----------------------------------------------------------------------
File    : IP_NI_AT91SAM9260.c
Purpose : NI driver for AT91SAM9260
...
//#define USE_RMII           (1)              // By default, use RMII

#define TX_BUFFER_SIZE     (1536)
//#define TX_MEM_START_ADDR  (0x200000)       // Internal SRAM0, physical & virtual address
#define TX_MEM_SIZE        (0x1000)         // Internal SRAM0 is 4KB
#define NUM_TX_BUFFERS     (1)

#define USE_RMII           (0)              // By default, use RMII
#define TX_MEM_START_ADDR  (0x300000)       // Internal SRAM0, physical & virtual address
...
/*********************************************************************
*
*       AT91SAM9260 peripheral addresses, sfrs and related control bits
*/
//
// RSTC peripheral
//
...
/*********************************************************************
*
*       IP_Driver_SAM9260_ConfigNumRxBuffers
*
*  Function description
...
**********************************************************************
*/
const IP_HW_DRIVER IP_Driver_SAM9260 = {
  _Init,
  _SendPacketIfTxIdle,
  _GetPacketSize,
  _ReadPacket,
