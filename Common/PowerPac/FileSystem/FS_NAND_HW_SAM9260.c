...
void FS_NAND_HW_X_Init_x8(U8 Unit) {
  ...
  SMC0_SETUP3 = (0x01 <<  0)  // 1 cycle nWE setup length
              ...
              ;
  SMC0_PULSE3 = (0x03 <<  0)  // 3 cycles nWR pulse length
              ...
              ;
  SMC0_CYCLE3 = (0x05 <<  0)  // 5 cycles for complete write length
...
/*
  //
  //  Set PIOC pin 13 as port pin, for use as NAND Ready/Busy line.
  //
  PIOC_ODR  = 1 << 13;    // Configure input
  PIOC_PER  = 1 << 13;    // Set pin as port pin
*/
  //
