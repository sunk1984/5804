...
#if defined (__ARM7M__) && (__CORE__ == __ARM7M__) || defined  (__ARM6M__) && (__CORE__ == __ARM6M__)  || defined (__ARM7EM__) && (__CORE__ == __ARM7EM__)  // Cortex-M specific part
...
#define OS_VERSION_GENERIC (38213)       /*   Generic version 3.82m */
...
/****** Thread local storage, may be enabled in CPU speic part ******/
...
#else // End of Cortex-M specific part, begin of ARM specific part
...
#endif // End of ARM7/9 specific part
